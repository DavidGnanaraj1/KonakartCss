...
public class PageActions extends BrowserInvoke {
	...
	public  void click( String path,String locator) throws IOException, InterruptedException {
   // selloc.selLocators(path,locator)
	...
	public  void dropdown( String path,String locator, String value) throws IOException, InterruptedException {
	...
	public  void sendKeys( String path,String locator, String value) throws IOException, InterruptedException {
